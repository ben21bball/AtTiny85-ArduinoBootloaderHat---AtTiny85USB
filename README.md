...
This repository contains a project for an Arduino hat PCB for downloading a bootloader onto an ATtiny85 microcontroller and a PCB-based USB device for directly sending code to the ATtiny85. All PCB designs were intended to be single-sided PCBs to enable the most amount of tinkerers to create this to save them time with the ATtiny85 bootloading and programming. Hopefully this saves you time and money when making circuits to use the ATtiny85 with the Arduino IDE. 
